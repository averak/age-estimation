...
class Analyzer(BaseAnalyzer):
    ...
    def export_heatmap(self, train_humans: list, test_humans: list, train_results: np.ndarray, test_results: np.ndarray):
        ...
        ax = figure.add_subplot(111)
        ax.set_aspect('equal', adjustable='box')
        plt.hist2d(θ_M_pred_list_train, θ_M_true_list_train, bins=90, range=[(0, 90), (0, 90)], cmin=1)
        plt.colorbar()
        plt.xlabel("θ_M")
        plt.ylabel("Age")
        plt.xlim(0, 90)
        ...
        ax = figure.add_subplot(111)
        ax.set_aspect('equal', adjustable='box')
        plt.hist2d(θ_F_pred_list_train, θ_F_true_list_train, bins=90, range=[(0, 90), (0, 90)], cmin=1)
        plt.colorbar()
        plt.xlabel("θ_F")
        plt.ylabel("Age")
        plt.xlim(0, 90)
        ...
        ax = figure.add_subplot(111)
        ax.set_aspect('equal', adjustable='box')
        plt.hist2d(θ_M_pred_list_test, θ_M_true_list_test, bins=90, range=[(0, 90), (0, 90)], cmin=1)
        plt.colorbar()
        plt.xlabel("θ_M")
        plt.ylabel("Age")
        plt.xlim(0, 90)
        ...
        ax = figure.add_subplot(111)
        ax.set_aspect('equal', adjustable='box')
        plt.hist2d(θ_F_pred_list_test, θ_F_true_list_test, bins=90, range=[(0, 90), (0, 90)], cmin=1)
        plt.colorbar()
        plt.xlabel("θ_F")
        plt.ylabel("Age")
        plt.xlim(0, 90)
        ...
        ax = figure.add_subplot(111)
        ax.set_aspect('equal', adjustable='box')
        plt.hist2d(σ_M_pred_list_train, σ_M_true_list_train, bins=80, range=[(0, 50), (0, 50)], cmin=1)
        plt.colorbar()
        plt.xlabel("σ_M")
        plt.ylabel("|y-θ_M|")
        plt.xlim(0, 50)
        ...
        ax = figure.add_subplot(111)
        ax.set_aspect('equal', adjustable='box')
        plt.hist2d(σ_F_pred_list_train, σ_F_true_list_train, bins=80, range=[(0, 50), (0, 50)], cmin=1)
        plt.colorbar()
        plt.xlabel("σ_F")
        plt.ylabel("|y-θ_F|")
        plt.xlim(0, 50)
        ...
        ax = figure.add_subplot(111)
        ax.set_aspect('equal', adjustable='box')
        plt.hist2d(σ_M_pred_list_test, σ_M_true_list_test, bins=80, range=[(0, 50), (0, 50)], cmin=1)
        plt.colorbar()
        plt.xlabel("σ_M")
        plt.ylabel("|y-θ_M|")
        plt.xlim(0, 50)
        ...
        ax = figure.add_subplot(111)
        ax.set_aspect('equal', adjustable='box')
        plt.hist2d(σ_F_pred_list_test, σ_F_true_list_test, bins=80, range=[(0, 50), (0, 50)], cmin=1)
        plt.colorbar()
        plt.xlabel("σ_F")
        plt.ylabel("|y-θ_F|")
        plt.xlim(0, 50)
